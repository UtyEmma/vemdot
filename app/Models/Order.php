...
class Order extends Model {
    ...
    protected $fillable = [
        'unique_id', 'user_id', 'courier_id', 'bike_id', 'transaction_id', 'address_id', 'instructions', 'amount', 'receiver_id', 'delivery_fee', 'delivery_method', 'receiver_name', 'receiver_phone', 'receiver_location', 'receiver_email', 'reference', 'status', 'delivery_distance', 'meals', 'vendor_id', 'avg_time'
    ];
