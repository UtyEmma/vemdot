...
<div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
    {{ucfirst($user->settings->site_name)}} Login Alert on {{$user->date_format}}.
</div>
<!-- end preheader -->
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: 'Merriweather Bold', serif; border-top: 5px solid #1b1363;">
                        <h3 style="margin: 0;  line-height: 28px; text-align:center">{{ucfirst($user->settings->site_name)}} LOGIN ALERT ON {{$user->date_format}}.</h3>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
                        <p style="margin: 0;">{{ucfirst($user->settings->site_name)}} Login Notification</p>
                    </td>
                </tr>
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
                        <p style="margin: 0;">Hi, <b>{{$userDetails->name}}</b></p>
                        <p style="margin: 0;">There was a successful login to your {{ucfirst($user->settings->site_name)}} Account</p>
                        <p style="margin: 0;">Please see below for login details:</p>
                    </td>
                </tr>
                <!-- end copy -->
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td align="center" bgcolor="#f05a23" style="border-radius: 6px;">
                                                <h1 style="padding: 2px 5px; color:#ffff">
                                                    {{$user->date_format}}
                                                </h1>
                                            </td>
                                        </tr>
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
                       <p style="margin: 0;">If you did not login to your {{ucfirst($user->settings->site_name)}} account, kindly contact {{ucfirst($user->settings->site_name)}} (our 24/7 Live Support) or send an email to <a href="mailto::{{$user->settings->site_email}}">{{$user->settings->site_email}}</a>, stating your name and email.</p>
                    </td>
                </tr>
